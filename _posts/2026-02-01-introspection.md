...
For example, a feature description is consistent if it correctly predicts when that feature activates across diverse inputs, and a circuit description is consistent if intervening on parts of the circuit produces predictable changes in downstream activations or behaviors.
