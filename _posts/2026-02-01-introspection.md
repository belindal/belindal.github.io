...
While general versions of causality across all intervention types may be unenforceable, it is nonetheless a desirable property for the reasons listed below.[^3]
...
A model M1 possesses [**privileged**](https://arxiv.org/abs/2511.08579) [**access**](https://arxiv.org/abs/2506.05068) [to](https://arxiv.org/abs/2508.14802) [itself](https://arxiv.org/abs/2509.13316) if M1 demonstrates greater causal self-consistency to M1 than another model M2, if M2 is given access to M1's inputs and outpus, and an equivalent amount of training- and inference-time resources. <!--when M2 is given access to M1's inputs and outputs, and the same amount of . -->
...
At the extreme end, fully **introspective** methods give the model the ability to reason directly about itself. By exploiting privileged access to their own behaviors and computations, introspective methods enable faithful explanations at substantially lower cost than extrospective alternatives. Consequently, within the class of trained explainer models, introspective approaches dominate extrospective ones along the Pareto tradeoff.
